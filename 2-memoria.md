...
Si definimos memory-swap como 1g y memory como 300m, primero debemos convertir las unidades de memory-swap, 1g=1024m.
Entonces, Memoria swap maxima = 1024 - 300 = 724